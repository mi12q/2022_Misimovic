...
class Gun:
    ...
    def draw(self):
        pygame.draw.polygon(self.screen, self.color, [self.point1, self.point2, self.point3, self.point4])
...
def rotate_gun(gun):
    rotate_point(gun.point2, gun.point1, gun.an)
    rotate_point(gun.point3, gun.point1, gun.an)
    rotate_point(gun.point4, gun.point1, gun.an)
